...
# **Цель проекта** - разработать для фермера модель МО для прогнозирования удоя и вкуса молока для управления рисками и принятия объективного решения о покупке коров (на основе данных от одного из поставщиков коров -«ЭкоФермы»). 
# 
# **План:** 
# 
# 1. Загрузка данных. 
...
#     * cow_buy.csv - данные о коровах «ЭкоФермы», из числа которых планируется отобрать и приобрести коров. 
# 
# 
# 
...
# * cow_buy - данные о коровах «ЭкоФермы», из числа которых планируется отобрать и приобрести коров. 
...
# Считаем данные о коровах «ЭкоФермы» из csv-файла 'cow_buy.csv', сохраним полученный DataFrame в переменную **cow_buy**.
...
# ### 3.3 Проанализируем данные о коровах «ЭкоФермы» на основании **cow_buy**
...
# #### 3.4.3 В рамках статистического анализа данных о коровах «ЭкоФермы» (cow_buy):
...
# * Столбец ***'Порода'*** (*'breed'*) - порода коровы:    
#     * Всего уникальных значений (пород коров) = 2 породы; 
#     * Распределение пород среди коров стада «ЭкоФермы»: 
...
# ***Под данный критерий подходят все коровы, данные по которым предоставила «ЭкоФерма».***
...
# ***Под данный критерий подходят 6 коров, данные по которым предоставила «ЭкоФерма».***
...
# * ferma_dad.csv - данные об имени папы каждой коровы в стаде фермера; 
# * cow_buy.csv - данные, предоставленные компанией «ЭкоФермы», о коровах, из числа которых планируется отобрать и приобретение. 
# 
# 
# 
# **2. Предобработка данных:** 
...
# 
# 3.3) проанализированы данные о коровах «ЭкоФермы» на основании cow_buy; 
# 
...
# 5.5) прогноз удоя коров: 
# 
#     *Под критерий "удой свыше 6000 кг молока за год" подходят все коровы, данные по которым предоставила «ЭкоФерма».*
#     
#     
# **6. Задача классификации - прогноз вкуса молока:**
# 
...
# 6.3) Прогноз вкуса молока: 
# 
#     *Под критерий "молоко вкусное" подходят 6 коров, данные по которым предоставила «ЭкоФерма».*
# 
...
# 
# Фермеру рекомендуется приобрести одну корову у компании «ЭкоФерма» для минимизации рисков, но если требуется больше коров, то можно пренебречь доверительный интервал и выбрать коров с спрогнозированным удоем свыше 6000 кг (а не свыше 6395 кг), но это повысит риск. Для минимиации рисков по приобретению коров с вкусным молоком мы изменили порог вхождения, а также лучшили модель, чтобы фермер наибольшее число коров с вкусным молоком. 
